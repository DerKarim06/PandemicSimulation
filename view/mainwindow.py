...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_13.setText(_translate("MainWindow", "minimale Infektionsdauer (in Tagen):"))
        self.label_14.setText(_translate("MainWindow", "maximale Infektionsdauer (in Tagen:)"))
